...
\noindent Hiermit versichere ich an Eides Statt, dass ich die vorliegende Arbeit mit dem Titel \newline
\begin{center}
	\textbf{\myTitel}
\end{center}
\begin{center}
